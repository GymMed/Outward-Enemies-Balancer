...
:: Source paths
set "sourceDll=C:\Users\pc\source\repos\OutwardEnemiesBalancer\OutwardEnemiesBalancer\Release\OutwardEnemiesBalancer.dll"
...
if exist "%sourceDll%" (
    for %%p in (%profiles%) do (
        set "destinationDll=%baseProfilePath%\%%~p\BepInEx\plugins\gymmed-OutwardEnemiesBalancer"
